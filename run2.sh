...
# tools/train.py \
# configs/segmenter/segmenter-propagate_vit-b16_512x512_40k_bs_16_downsample_2_base_config_structure_margin_0.1_min_0.1_loss_weight_1.0_coco-stuff_rr1.py \
# --launcher pytorch

# python -m torch.distributed.launch --nproc_per_node=8 --master_port=233333 \
# tools/train.py \
# configs/segmenter/segmenter-propagate_vit-b16_512x512_40k_bs_16_downsample_2_base_config_structure_margin_0.2_min_0.0_loss_weight_1.0_coco-stuff_rr1.py \
# --launcher pytorch
...
python -m torch.distributed.launch --nproc_per_node=8 --master_port=233333 \
tools/train.py \
configs/segmenter/segmenter-propagate_vit-b16_512x512_40k_bs16_downsample_2_base_config_structure_region_temp_0.2_queue_32_loss_weight_0.1.py \
--launcher pytorch

# configs/segmenter/segmenter-propagate_vit-b16_512x512_40k_bs16_downsample_2_base_config_structure_region_temp_0.2_queue_32_loss_weight_0.5.py
