...
class VisionTransformerCLIP(BaseModule):
    """Vision Transformer.
    ...
    def __init__(
        ...
        # self.proj = nn.Parameter(scale * torch.randn(embed_dims, output_dim))
    ...
    def init_weights(self):
        if isinstance(self.pretrained, str):
            ...
            super(VisionTransformerCLIP, self).init_weights()
    ...
    def forward(self, inputs):
        ...
        # NOTE: add pre_norm here to match CLIP ViT-B/16 architecture
        x = self.norm0(x)
        ...
        for i, layer in enumerate(self.layers):
            ...
            if i in self.out_indices:
                ...
                B, _, C = out.shape
                # NOTE: Project to 512 dim to fit CLIP model
                # B, HW, C => B, HW, C'
                # out = out @ self.proj
                # B, C', H, W
                out = out.reshape(B, hw_shape[0], hw_shape[1], -1).permute(0, 3, 1, 2)
    ...
    def train(self, mode=True):
        super(VisionTransformerCLIP, self).train(mode)
