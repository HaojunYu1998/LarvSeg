...
# configs/segmenter/segmenter-propagate_vit-b16_160k_bs16_base_config_coco_no_attn_soft_structure_loss.py

bash tools/dist_train.sh \
configs/segmenter/segmenter-propagate_vit-b16_160k_bs16_base_config_coco_no_attn_structure_loss_local.py

# bash tools/dist_test.sh \
# configs/segmenter/evaluation/baseline_r101c_no_attn_eval_ade_tta.py \
