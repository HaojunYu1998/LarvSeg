...
novel_cls = list(set(in586_cls) - set(processed_coco))
base_cls = list(set(in586_cls) & set(processed_coco))
print(len(base_cls), len(novel_cls))
novel_cls = list(set(ade847_cls) - set(processed_coco))
base_cls = list(set(ade847_cls) & set(processed_coco))
print(len(base_cls), len(novel_cls))


novel_cls = list(set(CLASSES130) - set(processed_coco))
base_cls = list(set(CLASSES130) & set(processed_coco))
print(len(base_cls), len(novel_cls))

novel_cls = list(set(CLASSES150) - set(processed_coco))
