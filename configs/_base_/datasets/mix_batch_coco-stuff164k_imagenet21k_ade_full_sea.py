...
coco_data_root = '/mnt/haojun/itpsea4data/dataset/coco_stuff164k'
coco_train_pipeline = [
...
in21k_data_root = '/mnt/haojun/itpsea4data/dataset/imagenet22k_azcopy'
...
ade_data_root = '/mnt/haojun/itpsea4data/dataset/ADE20K_2021_17_01'
ade_test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(
    ...
    train=dict(
        ...
        dataset_list=[
            ...
            dict(
                ...
                split="in21k_inter_ade_full.txt",
