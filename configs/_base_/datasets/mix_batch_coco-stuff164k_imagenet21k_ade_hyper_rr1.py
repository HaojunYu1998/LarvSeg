...
ade_data_root = '/mnt/haojun2/dataset/ADEChallengeData2016'
ade_test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(
        type='MultiScaleFlipAug',
        img_scale=(2048, 512), #[(2048, 512), (3072, 768), (4096, 1024), (5120, 1280), (6144, 1536), (7168, 1792)],
...
data = dict(
    ...
    val=dict(
        type='ADE20KHyperDataset',
        data_root=ade_data_root,
        img_dir='images/validation',
        ann_dir='annotations_hypernym/validation',
