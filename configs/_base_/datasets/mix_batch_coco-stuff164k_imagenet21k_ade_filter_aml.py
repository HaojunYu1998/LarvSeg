...
coco_data_root = '/haojun_storage/dataset/coco_stuff164k'
coco_train_pipeline = [
...
in21k_data_root = '/haojun_storage/dataset/imagenet22k_azcopy'
...
ade_data_root = '/haojun_storage/dataset/ADEChallengeData2016'
ade_test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(
