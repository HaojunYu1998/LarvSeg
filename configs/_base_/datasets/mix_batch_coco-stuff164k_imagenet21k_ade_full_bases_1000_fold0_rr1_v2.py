...
coco_data_root = '/mnt/haojun/dataset/coco_stuff164k'
coco_train_pipeline = [
...
in21k_data_root = '/mnt/haojun/dataset/imagenet22k_azcopy'
...
ade_data_root = '/mnt/haojun/dataset/ADE20K_2021_17_01'
ade_test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(
    ...
    train=dict(
        ...
        dataset_list=[
            ...
            dict(
                ...
                split="in21k_bases_1000_fild0.txt",
                img_suffix=".JPEG",
                seg_map_suffix=".JPEG",
