_base_ = [
    ...
    "../_base_/datasets/mix_batch_coco-stuff164k_imagenet21k_ade_hyper_multiscale_rr1.py",
...
model = dict(
    ...
    decode_head=dict(
        ...
        n_cls=93,
        cls_emb_path="pretrain/cls_emb_ade20k_hyper_vild_v3.pth",
        cls_emb_path_test="pretrain/cls_emb_ade20k_hyper_vild_v3.pth",
        # imagenet_class_path="notebook/in21k_inter_ade_filter_v2.json",
        test_anno_dir="/mnt/haojun2/dataset/ADEChallengeData2016/annotations_hypernym/validation",
        prior_rate=0.1,
