_base_ = [
    ...
    "../_base_/datasets/ade20kfull_hyper_multiscale_rr1.py",
...
model = dict(
    ...
    decode_head=dict(
        ...
        n_cls=429,
        cls_emb_path="pretrain/cls_emb_ade_full_hyper_vild.pth",
        cls_emb_path_test="pretrain/cls_emb_ade_full_hyper_vild.pth",
        # imagenet_class_path="notebook/in21k_inter_ade_filter_v2.json",
        test_anno_dir="/mnt/haojun2/dataset/ADE20K_2021_17_01/annotations_detectron2/validation_hypernym",
        prior_rate=0.1,
