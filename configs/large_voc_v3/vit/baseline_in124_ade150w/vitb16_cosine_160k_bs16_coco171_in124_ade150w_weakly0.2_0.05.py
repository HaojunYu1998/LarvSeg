_base_ = [
    ...
    "../../../_base_/datasets/mix_batch_IN124_COCO171_ADE150W_eval_ADE150.py",
...
model = dict(
    ...
    decode_head=dict(
        ...
        mix_batch_datasets=["in124", "coco171", "ade150", "coco171"],
        test_dataset="ade150",
        ignore_indices=[255, 255, 255, 255],
        basic_loss_weights=[0.2, 1.0, 0.05, 1.0],
