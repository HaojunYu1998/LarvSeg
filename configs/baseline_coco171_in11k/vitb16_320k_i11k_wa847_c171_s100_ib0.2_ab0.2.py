_base_ = [
    ...
    "../_base_/datasets/mix_batch_IN11K_ADE847W_COCO171_eval_ADE847.py",
...
model = dict(
    ...
    decode_head=dict(
        ...
        mix_batch_datasets=["in11k", "ade847", "coco171"],
        weakly_supervised_datasets=["in11k"],
        test_dataset="ade847",
        ignore_indices=[-1, -1, 255],
        test_ignore_index=-1,
        use_sample_class=True,
        num_smaple_class=100,
        basic_loss_weights=[0.2, 0.2, 1.0],
