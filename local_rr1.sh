...
sudo nvidia-docker run \
    --rm --ipc=host ${FLAG} \
    -v "$PWD":/workspace \
    -v /mnt/haojun2/dataset/ADEChallengeData2016:/mdata/ade/ADEChallengeData2016/ \
    -v /mnt/haojun2/dataset/ADE20K_2021_17_01:/mdata/ade20k_full \
    -v /mnt/haojun2/dataset/coco_stuff164k:/mdata/coco_stuff164k \
    -v /mnt/haojun2/dataset/imagenet22k_azcopy:/mdata/imagenet21k \
    -v /mnt:/mnt \
    -u $(id -u):$(id -g) \
    "${IMAGE}" \
    bash -c "$CMD"
